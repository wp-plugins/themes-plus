...
(function ($) {
	...
	var $progresschart = $('.chart .easyPieChart');
    ...
    function startProgresschartAnimation () {
        $progresschart.each(function () {
			...
			var $this = $(this),
				$value = $this.data('value'); // Initial value: data-percent="0" -> Get value via new attribute data-value="$(this).data('value')"
			
            if (isElementInViewport($this) && $this.data('animate') == 'on') {
